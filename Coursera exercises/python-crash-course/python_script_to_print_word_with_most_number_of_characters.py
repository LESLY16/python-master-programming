...
print(longest_word("chair", "couch", "table")) #should be chair
print(longest_word("bed", "bath", "beyond")) #should be beyond
print(longest_word("laptop", "notebook", "desktop")) #should be notebook